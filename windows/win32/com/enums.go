...
const (
	MAX_ZONE_PATH        __MIDL_IInternetZoneManager_0001 = 260
	MAX_ZONE_DESCRIPTION __MIDL_IInternetZoneManager_0001 = 200
)
...
const (
	PRINTFLAG_MAYBOTHERUSER        __MIDL_IPrint_0001 = 1
	PRINTFLAG_PROMPTUSER           __MIDL_IPrint_0001 = 2
	PRINTFLAG_USERMAYCHANGEPRINTER __MIDL_IPrint_0001 = 4
	PRINTFLAG_RECOMPOSETODEVICE    __MIDL_IPrint_0001 = 8
	PRINTFLAG_DONTACTUALLYPRINT    __MIDL_IPrint_0001 = 16
	PRINTFLAG_FORCEPROPERTIES      __MIDL_IPrint_0001 = 32
	PRINTFLAG_PRINTTOFILE          __MIDL_IPrint_0001 = 64
)
