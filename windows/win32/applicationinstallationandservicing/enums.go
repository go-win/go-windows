...
const (
	ASM_BINDF_FORCE_CACHE_INSTALL __MIDL_IAssemblyName_0002 = 1
	ASM_BINDF_RFS_INTEGRITY_CHECK __MIDL_IAssemblyName_0002 = 2
	ASM_BINDF_RFS_MODULE_CHECK    __MIDL_IAssemblyName_0002 = 4
	ASM_BINDF_BINPATH_PROBE_ONLY  __MIDL_IAssemblyName_0002 = 8
	ASM_BINDF_SHARED_BINPATH_HINT __MIDL_IAssemblyName_0002 = 16
	ASM_BINDF_PARENT_ASM_HINT     __MIDL_IAssemblyName_0002 = 32
)
