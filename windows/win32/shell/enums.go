...
type FILEOPENDIALOGOPTIONS int32
...
type HLSR_NOREDEF10 int32

const (
	HLSR_HOME          HLSR_NOREDEF10 = 0
	HLSR_SEARCHPAGE    HLSR_NOREDEF10 = 1
	HLSR_HISTORYFOLDER HLSR_NOREDEF10 = 2
)

type HLSHORTCUTF__NOREDEF10 int32

const (
	HLSHORTCUTF_DEFAULT                     HLSHORTCUTF__NOREDEF10 = 0
	HLSHORTCUTF_DONTACTUALLYCREATE          HLSHORTCUTF__NOREDEF10 = 1
	HLSHORTCUTF_USEFILENAMEFROMFRIENDLYNAME HLSHORTCUTF__NOREDEF10 = 2
	HLSHORTCUTF_USEUNIQUEFILENAME           HLSHORTCUTF__NOREDEF10 = 4
	HLSHORTCUTF_MAYUSEEXISTINGSHORTCUT      HLSHORTCUTF__NOREDEF10 = 8
)

type HLTRANSLATEF_NOREDEF10 int32

const (
	HLTRANSLATEF_DEFAULT                HLTRANSLATEF_NOREDEF10 = 0
	HLTRANSLATEF_DONTAPPLYDEFAULTPREFIX HLTRANSLATEF_NOREDEF10 = 1
)

type MIDL_IHlink_0001 int32

const (
	HLNF_INTERNALJUMP          MIDL_IHlink_0001 = 1
	HLNF_OPENINNEWWINDOW       MIDL_IHlink_0001 = 2
	HLNF_NAVIGATINGBACK        MIDL_IHlink_0001 = 4
	HLNF_NAVIGATINGFORWARD     MIDL_IHlink_0001 = 8
	HLNF_NAVIGATINGTOSTACKITEM MIDL_IHlink_0001 = 16
	HLNF_CREATENOHISTORY       MIDL_IHlink_0001 = 32
)

type MIDL_IHlink_0002 int32

const (
	HLINKGETREF_DEFAULT  MIDL_IHlink_0002 = 0
	HLINKGETREF_ABSOLUTE MIDL_IHlink_0002 = 1
	HLINKGETREF_RELATIVE MIDL_IHlink_0002 = 2
)

type MIDL_IHlink_0003 int32

const (
	HLFNAMEF_DEFAULT          MIDL_IHlink_0003 = 0
	HLFNAMEF_TRYCACHE         MIDL_IHlink_0003 = 1
	HLFNAMEF_TRYPRETTYTARGET  MIDL_IHlink_0003 = 2
	HLFNAMEF_TRYFULLTARGET    MIDL_IHlink_0003 = 4
	HLFNAMEF_TRYWIN95SHORTCUT MIDL_IHlink_0003 = 8
)

type MIDL_IHlink_0004 int32

const (
	HLINKMISC_RELATIVE MIDL_IHlink_0004 = 1
)

type MIDL_IHlink_0005 int32

const (
	HLINKSETF_TARGET   MIDL_IHlink_0005 = 1
	HLINKSETF_LOCATION MIDL_IHlink_0005 = 2
)

type MIDL_IHlinkSite_0001 int32

const (
	HLINKWHICHMK_CONTAINER MIDL_IHlinkSite_0001 = 1
	HLINKWHICHMK_BASE      MIDL_IHlinkSite_0001 = 2
)

type MIDL_IHlinkBrowseContext_0001 int32

const (
	HLTB_DOCKEDLEFT   MIDL_IHlinkBrowseContext_0001 = 0
	HLTB_DOCKEDTOP    MIDL_IHlinkBrowseContext_0001 = 1
	HLTB_DOCKEDRIGHT  MIDL_IHlinkBrowseContext_0001 = 2
	HLTB_DOCKEDBOTTOM MIDL_IHlinkBrowseContext_0001 = 3
	HLTB_FLOATING     MIDL_IHlinkBrowseContext_0001 = 4
)

type MIDL_IHlinkBrowseContext_0002 int32

const (
	HLBWIF_HASFRAMEWNDINFO   MIDL_IHlinkBrowseContext_0002 = 1
	HLBWIF_HASDOCWNDINFO     MIDL_IHlinkBrowseContext_0002 = 2
	HLBWIF_FRAMEWNDMAXIMIZED MIDL_IHlinkBrowseContext_0002 = 4
	HLBWIF_DOCWNDMAXIMIZED   MIDL_IHlinkBrowseContext_0002 = 8
	HLBWIF_HASWEBTOOLBARINFO MIDL_IHlinkBrowseContext_0002 = 16
	HLBWIF_WEBTOOLBARHIDDEN  MIDL_IHlinkBrowseContext_0002 = 32
)

type MIDL_IHlinkBrowseContext_0003 int32

const (
	HLID_INVALID     MIDL_IHlinkBrowseContext_0003 = 0
	HLID_PREVIOUS    MIDL_IHlinkBrowseContext_0003 = -1
	HLID_NEXT        MIDL_IHlinkBrowseContext_0003 = -2
	HLID_CURRENT     MIDL_IHlinkBrowseContext_0003 = -3
	HLID_STACKBOTTOM MIDL_IHlinkBrowseContext_0003 = -4
	HLID_STACKTOP    MIDL_IHlinkBrowseContext_0003 = -5
)

type MIDL_IHlinkBrowseContext_0004 int32

const (
	HLQF_ISVALID   MIDL_IHlinkBrowseContext_0004 = 1
	HLQF_ISCURRENT MIDL_IHlinkBrowseContext_0004 = 2
)
